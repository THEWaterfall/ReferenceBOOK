...
public class AddEmployeeController {
	...
	public void saveBtnClicked(ActionEvent event) throws IOException, ClassNotFoundException, SQLException {
		EmployeeDAO.insertEmployee(nameField.getText(), lastNameField.getText(), emailField.getText(), phoneNumberField.getText(), Integer.parseInt(salaryField.getText()), Integer.parseInt(managerIdField.getText()), Integer.parseInt(departmentIdField.getText()));
